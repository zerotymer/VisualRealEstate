...
namespace APIQueryLibrary.NSDI.AdmService.Sigungu
{
    /// <summary>
    /// 시군구조회
    /// </summary>
    [Attributes.QueryRequestInfo("시군구조회(법정동조회서비스)", ServiceProvider = "국토정보서비스", Description = "영토적 또는 행정적 단위를 시도, 시군구, 읍면동, 리, 동명으로 구분하여 나타낸 정보")]
    public sealed class NSDIAdmSvcSigunguRequest : Base.NSDIAdmSvcRequestBase, Interfaces.IXmlRequestable<Common.NSDIAdmSvcCommonResponse>, Interfaces.IJsonRequestable<Common.NSDIAdmSvcCommonResponse>
    {
        #region 정적요소(Statics)
        private static readonly String XML_URL = "http://openapi.nsdi.go.kr/nsdi/eios/service/rest/AdmService/admSiList.xml";
        private static readonly String JSON_URL = "http://openapi.nsdi.go.kr/nsdi/eios/service/rest/AdmService/admSiList.json";
        #endregion
