...
namespace APIQueryLibrary.Molit.RTMSDataSvcAptTradeDev
{
    ...
    public sealed class RTMSDataSvcAptTradeDevBody
    {
        // 공통구현부분
        ...
        [System.Xml.Serialization.XmlArrayItem(typeof(RTMSDataSvcAptTradeDevResponseItem), ElementName = "item")]
        [Newtonsoft.Json.JsonProperty(PropertyName = "items", Required = Newtonsoft.Json.Required.AllowNull)]
        public RTMSDataSvcAptTradeDevResponseItem[] Items { get; set; }
        #endregion
