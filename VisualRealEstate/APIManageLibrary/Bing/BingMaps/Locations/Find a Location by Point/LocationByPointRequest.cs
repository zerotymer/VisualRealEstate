...
namespace APIQueryLibrary.Bing.BingMaps.Locations.FindaLocationbyPoint
{
    /// <summary>
    ...
    /// <para/>https://msdn.microsoft.com/en-us/library/ff701710.aspx
    /// </summary>
    [QueryRequestInfo("Find a Location By Point (BingMaps)")]
    public sealed class LocationByPointRequest : BingMapsRequestBase, Interfaces.IXmlRequestable<BingMapsResponse>, Interfaces.IJsonRequestable<BingMapsResponse>, Interfaces.IQueryDocument
    {
        ...
        [QueryParam(Key = "adminDistrcit", IsNullable = false, Default = "", Description = "법정동")]
        ...
        [QueryParam(Key = "locality", IsNullable = false, Default = "", Description = "소재지")]
        ...
        [QueryParam(Key = "postalCode", IsNullable = false, Default = "")]
        ...
        [QueryParam(Key = "addressLine", IsNullable = false, Default = "", Description = "우편번호")]
        ...
        [QueryParam(Key = "countryRegion", IsNullable = false, Default = "", Description = "국가코드 (ISO)")]
        ...
        /// </value>
        [Attributes.QueryParam(Key = "includeNeighborhood", IsNullable = false, Default = 1, Description = "인접 지역정보 포함여부")]
        ...
        [Attributes.QueryParam(Key = "maxResults", IsNullable = false, Default = 5, Description = "반환수")]
        public uint MaxResults { get; set; } = 5;
        #endregion


        #region 메서드(Methods)
        // INHERITANCE: GetQuery()
