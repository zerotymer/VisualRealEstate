...
{
    /// <summary>
    /// 공동주택 단지 목록제공 서비스(법정동)
    /// </summary>
    /// <remarks>법정동 주소로 조회된 아파트 목록을 제공합니다.</remarks>
    // 참고 서비스 버전 1.0
    [QueryRequestInfo("공동주택 단지 목록제공 서비스(법정동)", ServiceProvider = "공공데이터포털", Description = "법정동 주소로 조회된 아파트 목록을 제공합니다.")]
    public sealed class AptListRequestByLegalDong : Base.PublicDataRequestBase, Interfaces.IQueryDocument, Interfaces.IXmlRequestable<PublicDataResponse<AptListResponseItem>>
    {
        #region 필드(Fields)
        ...
        /// 법정코드
        /// </summary>
        /// <remarks>시군구번호+법정동번호</remarks>
        /// <example>26380101100</example>
        [QueryParam(Key = "loadCode", IsNullable = false, Description = "법정코드")]
