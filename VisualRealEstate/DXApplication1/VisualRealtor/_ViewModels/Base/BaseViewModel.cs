...
namespace VisualRealtor.ViewModels.Base
{
    public class BaseViewModel : ViewModelBase
    {
        ...
        protected virtual CommandViewModel CreateEditMenu()
        {
            ...
            CommandViewModel cutCommand = new CommandViewModel("잘라내기") { Glyph = Images.Cut, KeyGesture = new KeyGesture(Key.X, ModifierKeys.Control) };
            CommandViewModel copyCommand = new CommandViewModel("복사") { Glyph = Images.Copy, KeyGesture = new KeyGesture(Key.C, ModifierKeys.Control) };
            CommandViewModel pasteCommand = new CommandViewModel("붙여넣기") { Glyph = Images.Paste, KeyGesture = new KeyGesture(Key.V, ModifierKeys.Control) };
        ...
        protected List<CommandViewModel> CreateStandardToolbarCommands()
        {
            return new List<CommandViewModel>() { };
        }
        #endregion
